...
router.get("/new", middleware.isLoggedIn, function(req, res){          //REMOVED /campgrounds as it's now in the path in the app.js file
...
router.post("/", middleware.isLoggedIn, function(req, res){
    ...
    var newCampground = {name: searchterm, image: imglink, description: campdescription, author: author, price: price};
...
router.get("/:id/edit", middleware.checkCampgroundOwnership, function(req,res){            // ADDED IN MIDDLEWARE
...
router.delete("/:id", middleware.checkCampgroundOwnership, function(req,res){              // ADDED IN MIDDLEWARE
